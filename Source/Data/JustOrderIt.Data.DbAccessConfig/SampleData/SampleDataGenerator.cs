namespace JustOrderIt.Data.DbAccessConfig.SampleDataGenerators
{
    ...
    public class SampleDataGenerator : ISampleDataGenerator
    {
        ...
        public void GenerateApplicationRoles(JustOrderItDbContext context)
        {
        ...
        public void GenerateApplicationUsers(JustOrderItDbContext context)
        {
        ...
        public void GenerateApplicationUserRoles(JustOrderItDbContext context)
        {
            if (!context.UserRoles.Any())
            {
                context.UserRoles.AddOrUpdate(
                    ...
                    {
                        UserId = context.Users.FirstOrDefault(u => u.UserName.ToLower() == "admin".ToLower()).Id,
                        UserName = "admin",
                        RoleId = context.Roles.FirstOrDefault(r => r.Name.ToLower() == IdentityRoles.Admin.ToLower()).Id,
                ...
                var userEntities = context.Users.Where(u => u.UserName.ToLower() != "admin".ToLower());
        ...
        public void GenerateCategories(JustOrderItDbContext context)
        {
        ...
        public void GenerateKeywords(JustOrderItDbContext context)
        {
        ...
        public void GenerateSearchFilters(JustOrderItDbContext context)
        {
        ...
        public void GenerateTags(JustOrderItDbContext context)
        {
            if (!context.Tags.Any())
            {
        ...
        public void GenerateProducts(JustOrderItDbContext context)
        {
            if (!context.Products.Any())
            {
                ...
                #region Appliances
                    new Product
                    {
                        ...
                        {
                            new Image { OriginalFileName = "41KLCZojhyL.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "1/41KLCZojhyL.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "41RqSZ2LN3L.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "1/41RqSZ2LN3L.jpg" },
                            new Image { OriginalFileName = "61EPxCNK-9L._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "1/61EPxCNK-9L._SL1500_.jpg" },
                            new Image { OriginalFileName = "71eIUJoOFJL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "1/71eIUJoOFJL._SL1500_.jpg" },
                            new Image { OriginalFileName = "81HvkJgXcgL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "1/81HvkJgXcgL._SL1500_.jpg" },
                        },
                        QuantityInStock = 50,
                        UnitPrice = 37.95M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "81K820M6oTL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "2/81K820M6oTL._SL1500_.jpg" },
                            new Image { OriginalFileName = "91bkQ3Oid-L._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "2/91bkQ3Oid-L._SL1500_.jpg" },
                            new Image { OriginalFileName = "912wST6G8HL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "2/912wST6G8HL._SL1500_.jpg", IsMainImage = true },
                        },
                        QuantityInStock = 37,
                        UnitPrice = 329.99M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "71rH1tH6pOL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "3/71rH1tH6pOL._SL1500_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "81l0eW5grOL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "3/81l0eW5grOL._SL1500_.jpg" },
                            new Image { OriginalFileName = "71uFRVmKasL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "3/71uFRVmKasL._SL1500_.jpg" },
                            new Image { OriginalFileName = "81EJUhnDmmL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "3/81EJUhnDmmL._SL1500_.jpg" },
                            new Image { OriginalFileName = "71G-SaQzcXL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "3/71G-SaQzcXL._SL1500_.jpg" },
                            new Image { OriginalFileName = "41vsyGjbk6L.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "3/41vsyGjbk6L.jpg" },
                        },
                        QuantityInStock = 6,
                        UnitPrice = 373.44M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "61Vygt70LoL._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "4/61Vygt70LoL._SL1000_.jpg" },
                            new Image { OriginalFileName = "617GMI9ak3L._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "4/617GMI9ak3L._SL1000_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "61dJEp8OO0L._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "4/61dJEp8OO0L._SL1000_.jpg" },
                            new Image { OriginalFileName = "61nt8UUpyzL._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "4/61nt8UUpyzL._SL1000_.jpg" },
                            new Image { OriginalFileName = "61-7zp+dx8L._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "4/61-7zp+dx8L._SL1000_.jpg" },
                        },
                        QuantityInStock = 27,
                        UnitPrice = 199.99M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "41dRCxTHQ7L._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "5/41dRCxTHQ7L._SL1000_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "51JUEoBK3nL._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "5/51JUEoBK3nL._SL1000_.jpg" },
                            new Image { OriginalFileName = "51quPoAJd8L._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "5/51quPoAJd8L._SL1000_.jpg" },
                            new Image { OriginalFileName = "61-ScPHiImL._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "5/61-ScPHiImL._SL1000_.jpg" },
                            new Image { OriginalFileName = "61xr5a-ht9L._SL1000_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "5/61xr5a-ht9L._SL1000_.jpg" },
                        },
                        QuantityInStock = 76,
                        UnitPrice = 39.99M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "71ZOjf2YelL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "6/71ZOjf2YelL._SL1500_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "71dTMxypLVL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "6/71dTMxypLVL._SL1500_.jpg" },
                            new Image { OriginalFileName = "81YLcs3SAML._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "6/81YLcs3SAML._SL1500_.jpg" },
                            new Image { OriginalFileName = "81XCc7rQDFL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "6/81XCc7rQDFL._SL1500_.jpg" },
                        },
                        QuantityInStock = 37,
                        UnitPrice = 129.95M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "81yPz5oTwQL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/81yPz5oTwQL._SL1500_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "617hYSNvgFL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/617hYSNvgFL._SL1500_.jpg" },
                            new Image { OriginalFileName = "81Xdd6spx1L._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/81Xdd6spx1L._SL1500_.jpg" },
                            new Image { OriginalFileName = "81sDBrQqkaL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/81sDBrQqkaL._SL1500_.jpg" },
                            new Image { OriginalFileName = "81rfOthjb-L._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/81rfOthjb-L._SL1500_.jpg" },
                            new Image { OriginalFileName = "81R0LZ3BlAL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/81R0LZ3BlAL._SL1500_.jpg" },
                            new Image { OriginalFileName = "41ycOPFHlaL.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/41ycOPFHlaL.jpg" },
                            new Image { OriginalFileName = "41nCIWsgBGL.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/41nCIWsgBGL.jpg" },
                            new Image { OriginalFileName = "41Af+MLhWbL.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "7/41Af+MLhWbL.jpg" },
                        },
                        QuantityInStock = 18,
                        UnitPrice = 159.00M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "71ekW3x5Q4L._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "8/71ekW3x5Q4L._SL1500_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "81BXZ4jB3nL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "8/81BXZ4jB3nL._SL1500_.jpg" },
                            new Image { OriginalFileName = "81hEU4cw-kL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "8/81hEU4cw-kL._SL1500_.jpg" },
                            new Image { OriginalFileName = "811IlCEr7EL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "8/811IlCEr7EL._SL1500_.jpg" },
                            new Image { OriginalFileName = "71v8CDuZ9fL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "8/71v8CDuZ9fL._SL1500_.jpg" },
                            new Image { OriginalFileName = "41NoqeaXK6L.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "8/41NoqeaXK6L.jpg" },
                        },
                        QuantityInStock = 112,
                        UnitPrice = 429.98M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "71KtILD2oXL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "9/71KtILD2oXL._SL1500_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "61+pCoKWraL._SL1397_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "9/61+pCoKWraL._SL1397_.jpg" },
                            new Image { OriginalFileName = "81exLIGPasL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "9/81exLIGPasL._SL1500_.jpg" },
                        },
                        QuantityInStock = 64,
                        UnitPrice = 180.00M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "71YALzAhflL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "10/71YALzAhflL._SL1500_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "81fxCRxRFGL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "10/81fxCRxRFGL._SL1500_.jpg" },
                            new Image { OriginalFileName = "81RWt6YF6aL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "10/81RWt6YF6aL._SL1500_.jpg" },
                            new Image { OriginalFileName = "81T-rhXPlQL._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "10/81T-rhXPlQL._SL1500_.jpg" },
                            new Image { OriginalFileName = "817oxKW4T3L._SL1500_.jpg", FileExtension = ".jpg", UrlPath = appliancesPath + "10/817oxKW4T3L._SL1500_.jpg" },
                        },
                        QuantityInStock = 27,
                        UnitPrice = 81.99M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Appliances").Id,
                ...
                #region Books
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "51-u3J3mtTL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "1/51-u3J3mtTL.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "51LM0-8ettL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "1/51LM0-8ettL.jpg" },
                            new Image { OriginalFileName = "41VQcpNMdwL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "1/41VQcpNMdwL.jpg" },
                        },
                        QuantityInStock = 16,
                        UnitPrice = 22.59M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Books").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "51FllqaDNGL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "2/51FllqaDNGL.jpg", IsMainImage = true },
                        },
                        QuantityInStock = 5,
                        UnitPrice = 26.89M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Books").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "41IOuBxV-uL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "3/41IOuBxV-uL.jpg", IsMainImage = true },
                        },
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "51EYDrfFa7L._SX343_BO1,204,203,200_.jpg", FileExtension = ".jpg", UrlPath = booksPath + "4/51EYDrfFa7L._SX343_BO1,204,203,200_.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "assimil-japanese-with-ease-volume-1-cd.png", FileExtension = ".png", UrlPath = booksPath + "4/assimil-japanese-with-ease-volume-1-cd.png" },
                        },
                        QuantityInStock = 3,
                        UnitPrice = 63.57M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Books").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "510mBd7W-RL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "5/510mBd7W-RL.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "51pAaq-sqdL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "5/51pAaq-sqdL.jpg" },
                            new Image { OriginalFileName = "31Vrx9NL7QL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "5/31Vrx9NL7QL.jpg" },
                        },
                        QuantityInStock = 7,
                        UnitPrice = 7.99M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Books").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "51JKFBsKz0L.jpg", FileExtension = ".jpg", UrlPath = booksPath + "6/51JKFBsKz0L.jpg", IsMainImage = true },
                        },
                        QuantityInStock = 9999,
                        UnitPrice = 11.99M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Books").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "51Wm-i6bhYL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "7/51Wm-i6bhYL.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "31Mmtij+gyL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "7/31Mmtij+gyL.jpg" },
                        },
                        QuantityInStock = 50,
                        UnitPrice = 7.05M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Books").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>
                        {
                            new Image { OriginalFileName = "51O1sI8z4SL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "8/51O1sI8z4SL.jpg", IsMainImage = true },
                        },
                        QuantityInStock = 9999,
                        UnitPrice = 10.93M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Books").Id,
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>()
                        {
                            new Image { OriginalFileName = "71+wsDV09DL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "9/71+wsDV09DL.jpg", IsMainImage = true },
                            new Image { OriginalFileName = "71WGl+k6YQL.jpg", FileExtension = ".jpg", UrlPath = booksPath + "9/71WGl+k6YQL.jpg" },
                        },
                        QuantityInStock = 12,
                        UnitPrice = 5.99M,
                        CategoryId = context.Categories.FirstOrDefault(c => c.Name == "Books").Id,
                ...
                #region Furniture
                    ...
                    new Product
                    {
                        ...
                        Images = new HashSet<Image>()
                        {
                            new Image { OriginalFileName = "41Y4VCdzX6L.jpg", FileExtension = ".jpg", UrlPath = furniturePath + "8/41Y4VCdzX6L.jpg", IsMainImage = true },
                ...
                // Sets a random number of sold units for each product.
                foreach (var product in context.Products)
                {
                    product.AllTimeItemsSold = random.Next(1000);
                }
        ...
        public void GenerateComments(JustOrderItDbContext context)
        {
        ...
        public void GenerateVotes(JustOrderItDbContext context)
        {
            ...
            if (context.Products.Any())
            {
                foreach (var product in context.Products)
                {
                    ...
                    if (product.Images.Any())
                    {
                        ...
                        {
                            image.UrlPath = this.GenerateImageFile(image.Id, image.UrlPath, image.OriginalFileName, image.FileExtension);
                        }
                    }
                }
        ...
        private string GenerateImageFile(int id, string physicalPath, string originalFileName, string fileExtension)
        {
        ...
        private ProcessedImage ProcessImage(int id, string physicalPath, string originalFileName, string fileExtension)
        {
            ...
            var smallSizeContent = this.imageProcessor.Resize(content, UiSpecificConstants.SmallSizeImageWidth);
            var thumbnailContent = this.imageProcessor.Resize(content, UiSpecificConstants.ThumbnailImageWidth);
            var highResContent = this.imageProcessor.Resize(content, UiSpecificConstants.HighResolutionWidth);
