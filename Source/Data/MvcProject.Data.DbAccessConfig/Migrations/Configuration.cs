        ...
        protected override void Seed(MvcProjectDbContext context)
        {
            ...
            if (!context.Tags.Any())
            {
                context.Tags.AddOrUpdate(
                    t => t.Name,
                    new Tag { Id = "1", Name = "duvka" },
                    new Tag { Id = "2", Name = "vafla" },
                    new Tag { Id = "3", Name = "bonbon" });
            ...
            if (!context.Products.Any())
            {
                context.Products.AddOrUpdate(
                    ...
                    new Product
                    {
                        ...
                        ShortDescription = "9-point focal plane phase-detection AF sensor. The compact, lightweight camera delivers superb image quality.",
                        DescriptionId = 5,
                        QuantityInStock = 414,
                        UnitPrice = 648.00M,
                        CategoryId = 3,
