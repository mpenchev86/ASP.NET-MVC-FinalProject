namespace JustOrderIt.Web.Controllers
{
    using System;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await this.SignInManager.PasswordSignInAsync(/*model.Email, */model.UserName, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
